        ...
        if($typeItemPOST == "deudordb"){            
            if(is_array($datas_Deudor) && !empty($datas_Deudor)){
                foreach($datas_Deudor as $deuKey){
                    ...
                    $fechanace_deudor = isset($datas_Deudor['fecha_nacimiento_deudor'])? date("d/m/Y", strtotime($datas_Deudor['fecha_nacimiento_deudor'])) : "";
                                ...
                                if(count($queryActividad) > 0){
                                    foreach($queryActividad as $qaKey){
                                        ...
                                        */
                                        ...
                                        $actividad_usuario_lyt .= "<b>".$tipoUsuario_actividad."</b>";                                        

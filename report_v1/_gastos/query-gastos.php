...
*QUERY GASTOS
*/
function queryGastos($idAcreedor_, $qDateStart_, $qDateEnd_){
    global $db;  
    $dataQuery = array();
    ...
    //$db->where('fecha_gastos', $qDateEnd_ "<=");
...
$datas_array = array();
$datas_array = queryGastos($idSSUser, $qDateStart, $qDateEnd);

...
<script>
    ...
    */       
    ...
    $(function(){
            ...
            */
            ...
            var tablarecaudos = $('#printdatatbl').DataTable({         
                ...
                "aoColumns": [
                    ...
                    {
                       "mData": "vence", "aTargets": [3],
                       "render": function (data) {
                           return data;
                       }
                    },
                    {
                       "mData": "valorcuota",  "sType": 'html-num-fmt', "aTargets": [4],
                       "render": function (data) {
                           return data;
                       }
                    },
                    {
                       "mData": "nombre", "aTargets": [5],
                       "render": function (data) {
                           return data;
                       }
                    },
                    ...
                    {
                       "mData": "barrio", "aTargets": [7],
                       "render": function (data) {
                           return data;
                       }
                    },
                    {
                       "mData": "dir", "aTargets": [8],
                       "render": function (data) {
                           return data;
                       }
                    },
                    {
                       "mData": "estado", "aTargets": [9],
                       "render": function (data) {
                           return data;
                       }
                    },
                    {
                       "mData": "valor", "aTargets": [10],
                       "render": function (data) {
                           return data;
                       }
                    }
                ...
                "footerCallback": function ( row, data, start, end, display ) {
                    ...
                    // Update footer
                    //$('#totalSalary').html(total_page_salary+" / "+total_salary );				
                    $('#totalSalary').html(total_salary).number( true, 0 );  
                },	
                "dom": "Bftip",                
                "buttons": [
                    {
        ...
        //$('#totalSalary').html().number( true, 2 );      
    });

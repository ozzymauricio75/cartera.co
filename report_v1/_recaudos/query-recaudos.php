...
*QUERY COBRADORES
*/
/*function queryCobradores($idSSUser_, $qDateStart_, $qDateEnd_, $qCobrador_ = null){
    global $db;  
    $dataQuery = array();
    $datasRecaudos = array();
    ...
    $queryTbl = $db->get("cobrador_tbl", null, "id_cobrador, nombre_cobrador");

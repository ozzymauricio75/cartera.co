                ...
                if (response['error']) {
                    ...
                    if(existeJSON == "true"){
                        ...
                        $('#'+parent+' .loaderrow').fadeOut(function(){
                            ...
                            $("#response"+datafield).html("<div class='alert alert-danger alert-dismissible'><button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button><h3><i class='icon fa fa-times fa-lg margin-right-xs'></i>Usuario registrado!<small style='display:block;' class='white-text'>Este usuario ya esta registrado en tu sistema y no puedes registrarlo nuevamente</small></h3><p style='display:block;'><strong class='text-size-x4'>"+deudornombreJSON+"</strong></p><p style='display:block;'>Cedula: <strong>"+deudorcedulaJSON+"</strong></p><p style='display:block;'>Usuario desde: <strong>"+deudorfecharegistroJSON+"</strong></p></div>").fadeIn("slow");

...
if(isset($_POST['idcredito_var']) && $_POST['idcredito_var'] != ""){
    $valorCobrar              = $_POST['valorporcobrar_var'];
    $nombrecompleto_deudor    = $_POST['nombredeudor_var'];
    $consecutivo_credito_ruta = $_POST['referenciarecaudo_var'];
    $porcentaje_progreso      = $_POST['porcentajeprogreso_var'];
    //Validacion variable POST
    $idItemPOST = $_POST['idcredito_var'];
    ...
    //Validacion TRUE - Querys en appweb/inc/query-payin.php
    if($valida_idCollectPOST === true && $valida_idCollectPOST === true){

        $loockVar = "true";
        $valorAcumulado = 0;
        $valorMoraAcumulado = 0;
        $valorRecaudosAcumulado = 0;
        $valorMoraAcumulado = queryValorMoraAcumulado($consecutivo_credito_ruta);
        $valorRecaudosAcumulado = queryValorAcumulado($consecutivo_credito_ruta);
        ...
        */
        ...
        $credito_sq->where('code_consecutivo_credito', $consecutivo_credito_ruta);
        ...
        //PROGRESO RECAUDOS
        $db->where('ref_recaudo', $consecutivo_credito_ruta);
...
<div class="wrapper">
    ...
    */
    ...
    <div class="content-wrapper box50" style="padding-top:20px; margin-left: auto; margin-right:auto;">
        ...
        */
        ...
        <section class="content-header bg-content-header">
            <h1>
                <span class="text-size-x6">Abonos</span> / Pagar
            </h1>
            <a href="<?php echo $pathmm."/".$payinDir."/abonos/"; ?>" class="ch-backbtn">
        ...
        */
            ...
            <div class="row">
                ...
                <div class="col-xs-12">
                    <p>
                        ...
                        <span class="pull-right text-size-x4"><?php echo $nombrecompleto_deudor; ?></span>
                    </p>
                    <p >
                    ...
                    <p>
                        <strong>Valor Por Cobrar</strong>
                        <span class="pull-right text-size-x4 text-red"><span class="margin-right-xs">$</span><?php echo $valorCobrar; ?></span>
                    </p>
        ...
        <section class="content">
            <div class="row">
                <div class="col-xs-12">
                    <form method="post" id="paycuotaabonoform" class="newrecaudoform">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <div class="input-group-addon"><i class="fa fa-dollar"></i></div>
                                <input type="text" class="form-control monedaval" name="valorrecibidoabono"/>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="comentainput" name="comentainput" class="form-control" placeholder="Escribe observaciones que necesites destacar en este abono" style="width: 100%; height: 120px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px; resize:none;"></textarea>
                        </div>

                        <div class="form-group">
                            <p id="valorfinalabono"></p>
                        </div>

                        <button id="addpayabono" type="button" class="btn btn-info btn-flat btn-block">Abonar</button>

                        <input type="hidden" name="numecuotaabono" value="<?php echo $numecuota_credito_ruta; ?>">
                        <input type="hidden" name="prestavarabono" value="<?php echo $id_acreedor_ruta; ?>">
                        <input type="hidden" name="cobradorvarabono" value="<?php echo $idSSUser; ?>">
                        <input type="hidden" name="recaudovarabono" value="<?php echo $id_recaudo_ruta; ?>">
                        <input type="hidden" name="refcreditoabono" value="<?php echo $consecutivo_credito_ruta; ?>">
                        <input type="hidden" name="valorpagarcuotaabono" value="<?php echo $valor_cuota_ruta; ?>">
                        <input type="hidden" name="valorfinalcuotaabono" value="<?php echo $valorFinalCuota; ?>">
                        <input type="hidden" name="valoracumladocuotaabono" value="<?php echo $valorRecaudosAcumulado; ?>">
                        <input type="hidden" name="valormoraestacuotaabono" value="<?php echo $valorMora_ruta; ?>">
                        <!--<input type="hidden" id="cobrarmoraestacuotaabono" name="cobrarmoraestacuotaabono">-->
                    ...
                    <div class="media text-muted">
                        ...
                        <div class="media-body">
                            ...
                            <p style="font-size:1.232em; line-height:1;">
                                No encontramos o fue eliminada EL ABONO que deseas visualizar
                            </p>
                            <p style="font-size:1.232em; line-height:1;"> Asegurate que seleccionaste el ABONO correcto, e intentalo de nuevo</p>
                        </div>
                ...
                <div class="margin-verti-xs">
                    <div class="btn-toolbar" role="toolbar">
                        <div class="btn-group text-center">
                            <a href="<?php echo $pathmm."/payin/abonos/"; ?>" type="button" class="btn btn-default">
                                <i class='fa fa-th-list fa-lg margin-right-xs'></i>
                                <span>Ir a Abonos</span>
                            </a>
                        </div>
                    </div>
                </div>
    ...
    <?php echo "<input id='pathdir' type='hidden' value='".$pathmm."/payin/abonos/'/>"; ?>
...
<script src="creud-new-abono.js" type="text/javascript"></script>
...
$(document).ready(function(){
    ...
    */
    ...
    $(".newplanpago").keyup(function(){
        ...
        var valorrecibidoabono = $(this).find('input[name="valorrecibidoabono"]').val();
        var valorpagarabono = $(this).find('input[name="valorpagarcuotaabono"]').val();
        ...
        var valordebe = parseFloat(valorpagarabono) - parseFloat(valorrecibidoabono);
        ...
        if(valordebe <= valorpagarabono){

            //$(this).find('#valordebe').html(valordebe).number( true, 2 );
        }else if(valordebe >= valorpagarabono){
            valordebe = 0;
           // $(this).find('#valordebe').html(valordebe).number( true, 2 );
        }
...
/*$("#switchmora").on('switchChange.bootstrapSwitch', function(event, state) {
    if($(this).is(':checked')) {
        ...
        $("#cobrarmoraestacuotaabono").val("ok");
    }else{
        //$("#moraval").attr("disabled", "disabled");
        $("#cobrarmoraestacuotaabono").val("");
    }
});*/
...
/*$("#switchabono").on('switchChange.bootstrapSwitch', function(event, state) {
    if($(this).is(':checked')) {
        ...
        /*$("#cobrarmoraestacuotaabono").attr("val", "ok");

...
<div class="wrapper">
    ...
    */
        ...
        */
        ...
        <section class="box50">
            <div class="row">
                ...
                if(isset($_GET['quservar']) && $_GET['quservar'] != ""){
                    ...
                    if($_GET['quservar'] == "ok"){
                        ...
                        if($valida_qval === true){
                            ...
                            */
                            $datasCuotasRuta = queryRecaudosRutaDetallesDeudor($idRutaHoy, $id_deudor); //queryCreditosDetalles($idSSUser, $idItemPOST);
                                ...
                                foreach($datasCuotasRuta as $dcrKey){
                                    ...
                                    */
                                    ...
                                    if($prevBox != $consecutivo_credito_ruta){
                                        ...
                                        $totalAcumuladoMora = 0;
                                        $totalAcumuladoMora = queryValorMoraAcumulado($consecutivo_credito_ruta);

                                        //suma el valor de mora si existe
                                        $valorFinalAcumulado = $totalAcumuladoCredito + $totalAcumuladoMora;
                          ...
                          <?php } /*[FIN |$datasCuotasRuta] -  Si la busqueda es por un deudor especifico*/
                        }
                    }
                }else {
                //fecha actual humano
                ...
                *DETALLES DE LOS RECAUDOS PARA ESTA RUTA
                */
                $datasCuotasRuta = queryRecaudosRutaDetallesCobrador($idRutaHoy, $idSSUser); //queryCreditosDetalles($idSSUser, $idItemPOST);
    ...
    <?php }//Termina el if donde valida si no busco un deudor especifico
      echo "<input id='paththisfile' type='hidden' value='".$pathFile."/pay/'/>";
    ?>

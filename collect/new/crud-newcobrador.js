$(document).ready(function(){ 
    ...
    $("#additembtn").click(function(){
        ...
        var form = document.getElementById('cobradorform');
            ...
            success: function (data) {
                ...
                if (response["error"]) { 
                    ...
                    $("#wrapadditem"+" .loader").fadeOut(function(){
                        ...
                        $("#wrapadditem").html("<div class='alert bg-success text-green alert-dismissible'><button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button><h4><i class='icon fa fa-check margin-right-xs'></i> Cobrador </h4><p style='display:block;'>La información del cobrador fue guardada con exito.</p></div>").fadeIn("slow");

...
<head>
    ...
    <title><?php echo METATITLE ?> - Reportes - Gastos <?php echo $dateFormatPost; ?></title>    
        ...
        */
        ...
        <section class="content-header bg-content-header">
            <h1>
                ...
                <span class="text-size-x6">Reportes</span> / Gastos
            </h1>
            ...
            */
            $('#printdatatbl').DataTable({	                
                ...
                "aoColumns": [
                    ...
                    {
                       "mData": "cobrador", "aTargets": [1],
                       "render": function (data) {
                           return data;
                       }
                    },
                    {
                       "mData": "valor", "aTargets": [2],
                       "render": function (data) {
                           return data;
                       }
                    },
                    {
                       "mData": "comentario", "aTargets": [3],
                       "render": function (data) {
                           return data;
                       }
                    }
                ...
                "footerCallback": function ( row, data, start, end, display ) {
                    ...
                    valor_total = api.column( 2 ).data().reduce( function (a, b) {
                        return intVal(a) + intVal(b);
                    },0 );

                    // valor_total_pagina over this page
                    valor_total_pagina = api.column( 2, { page: 'current'} ).data().reduce( function (a, b) {
                        return intVal(a) + intVal(b);
                    }, 0 );

...
<head>
    ...
    <title><?php echo METATITLE ?> - Reportes - Historico-credito_<?php echo $dateFormatPost; ?></title>    
    ...
    <div class="content-wrapper">
        ...
        */
        ...
        <section class="content-header bg-content-header">
            <h1>
                ...
                <span class="text-size-x6">Reportes</span> / Historia del credito
            </h1>
        ...
        */
            ...
            <div class="box-body">                
                <div class="form-inline">
                    ...
                    <div class="form-group">
                        ...
                        <button class="btn btn-default" id="refreshreport">
        ...
        <section class="content">                   
            <div class="row">      
                <div class="col-xs-12"><div id="successmsg"></div></div>
                <div class="col-xs-12 ">
                    <div class="box">                    
                        <div class="box-body table-responsive">
                            
                            <table id="printdatatbl" class="table table-striped" style="display-block; max-width:100%;">     
                                <thead>                                
                                    <tr>                                        
                                        <th >Ref. credito</th> 
...
<script>
    ...
    */       
    ...
    function getTabla(){ 
        var tablarecaudos = $('#printdatatbl').DataTable({                 
            ...
            "aoColumns": [                    
                ...
                {
                   "mData": "valorpagarcredito", "aTargets": [3],
                   "render": function (data) {
                       return data;
                   }
                },
                {
                   "mData": "valorcuotacredito", "aTargets": [4],
                   "render": function (data) {
                       return data;
                   }
                },
                {
                   "mData": "periocidadcredito", "aTargets": [5],
                   "render": function (data) {
                       return data;
                   }
                },
                {
                   "mData": "totalcuotascredito", "aTargets": [6],
                   "render": function (data) {
                       return data;
                   }
                },
                {
                   "mData": "plazocredito", "aTargets": [7],
                   "render": function (data) {
                       return data + " días";
                   }
                },
                {
                   "mData": "fechainiciocredito", "aTargets": [8],
                   "render": function (data) {
                       return data;
                   }
                },
                {
                   "mData": "fechafincredito", "aTargets": [9],
                   "render": function (data) {
                       return data;
                   }
                },                    
                {
                   "mData": "cuota", "aTargets": [10],
                   "render": function (data) {
                       return data;
                   }
                },
                {
                   "mData": "fechacobro", "aTargets": [11],
                   "render": function (data) {
                       return data;
                   }
                },
                {
                   "mData": "valorbasecuota", "aTargets": [12],
                   "render": function (data) {
                       return data;
                   }
                },
                {
                   "mData": "valormoracuota", "aTargets": [13],
                   "render": function (data) {
                       return data;
                   }
                },
                {
                   "mData": "valorpagarcuota", "aTargets": [14],
                   "render": function (data) {
                       return data;
                   }
                },
                {
                   "mData": "fechapago", "aTargets": [15],
                   "render": function (data) {
                       return data;
                   }
                },
                {
                   "mData": "valorrecaudado", "aTargets": [16],
                   "render": function (data) {
                       return data;
                   }
                },
                {
                   "mData": "valorfaltante", "aTargets": [17],
                   "render": function (data) {
                       return data;
                   }
                },
                {
                   "mData": "status", "aTargets": [18],
                   "render": function (data) {
                       return data;
                   }
                },
                {
                   "mData": "mora", "aTargets": [19],
                   "render": function (data) {
                       return data;
                   }
                },
                {
                   "mData": "nombre", "aTargets": [20],
                   "render": function (data) {
                       return data;
                   }
                },
                {
                   "mData": "cedula", "aTargets": [21],
                   "render": function (data) {
                       return data;
                   }
                },
                {
                   "mData": "telefono", "aTargets": [22],
                   "render": function (data) {
                       return data;
                   }
                },
                {
                   "mData": "direccion", "aTargets": [23],
                   "render": function (data) {
                       return data;
                   }
                }
    ...
    $("#refreshreport").click(function(){
        //cedulainput == "";
        //getTabla(cedulainput);    
        //$('#printdatatbl').DataTable().destroy();
        $("#iduser").val("");
        cedulainput = $("#iduser").val();
        getTabla(cedulainput);

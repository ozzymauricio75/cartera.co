...
if(is_array($datas_array) && !empty($datas_array)){
    foreach($datas_array as $daKey){
        ...
        $dinero_recaudar = 0;
        $dinero_para_capital = 0;
        $dinero_para_interes = 0;
        ...
        */
        ...
        "abonoacapital":"'.$dinero_para_capital.'",
        "abonoainteres":"'.$dinero_para_interes.'",
        "ingresoneto":"'.$ingreso_neto.'",
        "abonoacapitalreal":"'.$abono_capital.'",
        "abonoainteresreal":"'.$abono_interes.'",

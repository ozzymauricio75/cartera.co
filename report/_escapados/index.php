...
<head>
    ...
    <title><?php echo METATITLE ?> - Reportes-deudores-escapados_<?php echo $dateFormatPost; ?></title>    
        ...
        */
        ...
        <section class="content-header bg-content-header">
            <h1>
                ...
                <span class="text-size-x6">Reportes</span> / Deudores escapados
            </h1>
    ...
    */
    $('#printdatatbl').DataTable({	
        ...
        "aoColumns": [
            ...
            {
               "mData": "hora", "aTargets": [1],
               "render": function (data) {
                   return data;
               }
            },
            {
               "mData": "estado", "aTargets": [2],
               "render": function (data) {
                   return data;
               }
            },
            {
               "mData": "ciudad", "aTargets": [3],
               "render": function (data) {
                   return data;
               }
            },
            {
               "mData": "nombre", "aTargets": [4],
               "render": function (data) {
                   return data;
               }
            },
            {
               "mData": "cedula", "aTargets": [5],
               "render": function (data) {
                   return data;
               }
            },
            {
               "mData": "refcredito", "aTargets": [6],
               "render": function (data) {
                   return data;
               }
            },
            {
               "mData": "valordeuda", "aTargets": [7],
               "render": function (data) {
                   return data;
               }
            }

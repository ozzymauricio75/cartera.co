...
<head>
    ...
    <title><?php echo METATITLE ?> - Reportes - Recaudos-historico-recaudos_<?php echo $dateFormatPost; ?></title>    
        ...
        */
        ...
        <section class="content-header bg-content-header">
            <h1>
                ...
                <span class="text-size-x6">Reportes</span> / Historico recaudos por cobrador
            </h1>
            ...
            */
            ...
            var tablarecaudos = $('#printdatatbl').DataTable({                 
                ...
                "aoColumns": [
                    ...
                    {
                       "mData": "cedula", "aTargets": [4],
                       "render": function (data) {
                           return data;
                       }
                    },
                    {
                       "mData": "cuota", "aTargets": [5],
                       "render": function (data) {
                           return data;
                       }
                    },
                    {
                       "mData": "vence", "aTargets": [6],
                       "render": function (data) {
                           return data;
                       }
                    },
                    {
                       "mData": "fecharcaudo", "aTargets": [7],
                       "render": function (data) {
                           return data;
                       }
                    },
                    {
                       "mData": "dinerorecibido", "aTargets": [8],
                       "render": function (data) {
                           return data;
                       }
                    },
                    {
                       "mData": "valorcuota", "aTargets": [9],
                       "render": function (data) {
                           return data;
                       }
                    }
                ...
                "footerCallback": function ( row, data, start, end, display ) {
                    ...
                    valor_total = api.column( 8 ).data().reduce( function (a, b) {
                        return intVal(a) + intVal(b);
                    },0 );

                    // valor_total_pagina over this page
                    valor_total_pagina = api.column( 8, { page: 'current'} ).data().reduce( function (a, b) {
                        return intVal(a) + intVal(b);
                    }, 0 );

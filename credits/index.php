        ...
        <section class="content margin-bottom-md">
            ...
            <div class="row text-center">                
                <div class="col-xs-12 col-sm-6 col-md-4">
                    ...
                    <h3 style="margin-top:8px;">Prestado</h3>
                </div>
                <div class="col-xs-12 col-sm-6 col-md-4">
                    <a href="#" type="button" data-toggle="modal" data-target="#detallevalores">
                        <div class="box25 light-blue lighten-1 white-text padd-verti-xs img-rounded">
                    ...
                    <h3 style="margin-top:8px;">Creditos</h3>
                </div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-4">
                    ...
                    <h3 style="margin-top:8px;">Recaudado</h3>
                </div>
                <div class="clearfix hidden-xs hidden-sm visible-md"></div> 
                <div class="col-xs-12 col-sm-6 col-md-4">
                    <a href="#" type="button" data-toggle="modal" data-target="#detallevalores">
                        <div class="box25 light-blue lighten-1 white-text padd-verti-xs img-rounded">
                    ...
                    <h3 style="margin-top:8px;">Por cobrar</h3>
                </div>
                <div class="clearfix hidden-xs visible-sm hidden-md"></div> 
                <div class="col-xs-12 col-sm-6 col-md-4">
                    <a href="#" type="button" data-toggle="modal" data-target="#detallevalores">
                    ...
                    <h3 style="margin-top:8px;">Dinero perdido</h3>
                </div>

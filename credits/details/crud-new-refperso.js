$(document).ready(function(){ 
    ...
    $("#additembtn").click(function(){
        ...
        var form = document.getElementById('refpersoform');
            ...
            success: function (data) {
                ...
                if (response["error"]) { 
                    ...
                    $("#wrapadditem"+" .loader").fadeOut(function(){
                        ...
                        $("#wrapadditem").html("<div class='alert bg-success text-green alert-dismissible'><button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button><h4><i class='icon fa fa-check margin-right-xs'></i> Referencia personal </h4><p style='display:block;'>Esta referencia fue creada y asignada al credito con exito</p></div>").fadeIn("slow");
                        
                        //$("#left-barbtn").append("<a href='"+pathfile+"/"+ pathdir+"/details/' class='btn btn-default godetails' data-id='"+response+"'><i class='fa fa-chevron-left fa-1x margin-right-xs'></i>Volver al credito</a>").show();
                        
                        //$("#left-barbtn").append("<button data-href='"+pathfile+"/"+ pathdir+"/details/index.php' class='btn btn-default godetails' data-id='"+response+"'><i class='fa fa-chevron-left fa-1x margin-right-xs'></i>Volver al credito</button>").show();

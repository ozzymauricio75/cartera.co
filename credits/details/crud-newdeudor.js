$(document).ready(function(){ 
            ...
            success: function (data) {
                ...
                if (response["error"]) { 
                    ...
                    $("#wrapadditem"+" .loader").fadeOut(function(){
                        ...
                        $("#wrapadditem").html("<div class='alert bg-success alert-dismissible text-green'><button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button><h4><i class='icon fa fa-check margin-right-xs'></i> Deudor </h4><p style='display:block;'>Esta referencia fue creada y asignada al credito con exito</p></div>").fadeIn("slow");
                        
                        //$("#left-barbtn").append("<a href='"+pathfile+"/"+ pathdir+"/new-step2.php' class='btn btn-default'><span>Continuar</span><i class='fa fa-chevron-right fa-1x margin-left-xs'></i></a><a href='"+pathfile+"/"+ pathdir+"/new-step6.php' class='btn bg-teal margin-hori-xs'><span>Crear credito ahora</span><i class='fa fa-arrow-right fa-1x margin-left-xs'></i></a>").show();
                        $("#left-barbtn").show();
    ...
    $("#edititembtn").click(function(){
        ...
        */
        ...
        var parent = $("#wrapadditem");
        var emtyvalue = $(this).val();
        var datafield = "itemexist";
        var iduser = $("input[name='codeuserform']").val();//$("#codeuserform");
        var iditem = $("input[name='itemexistform']").val();
        var pseudouser = $("input[name='pseudouser']").val();
            ...
            success: function (data) {
                ...
                if (response["error"]) { 
                    ...
                    $("#wrapadditem"+" .loader").fadeOut(function(){
                        ...
                        $("#wrapadditem").html("<div class='alert bg-success alert-dismissible text-green'><button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button><h4><i class='icon fa fa-check margin-right-xs'></i> Deudor </h4><p style='display:block;'>La información del deudor fue guardada con exito. Continua con los siguientes pasos</p></div>").fadeIn("slow");
                        
                        $("#left-barbtn").append("<a href='"+paththisfile+"?cc="+Numero_Documento+"&existe=ok&dbtype=deudordb' class='btn btn-default margin-hori-xs'><span>Continuar</span><i class='fa fa-arrow-right fa-lg margin-left-xs'></i></a><a href='"+pathfile+"/"+ pathdir+"/new-step6.php' class='btn btn-success margin-hori-xs'><span>Crear credito ahora</span><i class='fa fa-arrow-right fa-lg margin-left-xs'></i></a>").show();
                        
                        $("#userexist-bartbtn").remove();   

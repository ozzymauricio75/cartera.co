            ...
            foreach($datasCredito as $dcKey){
                ...
                if(is_array($datas_Cuotas) && !empty($datas_Cuotas)){
                    foreach($datas_Cuotas as $dcKey){                                   
                        ...
                        $cuotaconmora = ($cuota_activa_mora == 1)? $cuota_mora : 0;
                        
                        //CALCULO DINERO PRESTADO
                        //$calculo_valor_prestado += $cuota_capital;
                        
                        //CALCULO VALOR CREDITO
                        $calculo_valor_credito += $cuota_valor_cuota + $cuotaconmora;
                        ...
                        //CALCULO VALOR POR COBRAR
                        if($cuota_status != "1"){
                            $calculo_valor_porcobrar += $cuota_valor_cuota + $cuotaconmora - $cuota_valor_recaudado; //= $valorPagar - $calculo_valor_recaudado;
                        }
                    }

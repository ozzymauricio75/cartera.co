    ...
    <div class="content-wrapper">
        ...
        */
        ...
        <section class="content-header bg-content-header">                        
            <h1>
                <span class="text-size-x6">Credito</span> / Nueva Referencia Familiar
            </h1>
        ...
        */
        ...
        <section class="content maxwidth-usersforms margin-bottom-lg">
            <form action="" id="reffamiform" autocomplete="off">
            <div class="">
                <div class="row wrapdivsection">
                    ...
                    <div class="col-xs-12 col-sm-8 ">
                        ...
                        <div class="form-group" id="reffamidb">
                            
                            <input type="number" id="cedulaform" name="cedulaform" class="form-control checkuser" value ="" placeholder="Número identidad" data-field="reffamidb" >     
                        </div>
                        <div id="responsereffamidb"></div>
                        <div id="errreffamidb"></div>
                    </div>
                ...
                */
                ...
                <div class="userexiste" >
                    ...
                    <div class="row wrapdivsection">
                        ...
                        <div class="col-xs-12 col-sm-8">                                    
                            <div class="form-group" id="tel1reffamidb">                                
                                <input type="tel" id="existTelefono1form" name="existTelefono1form" class="form-control editexist" value ="" placeholder="Telefono Fijo" data-field="tel1reffamidb">    
                                <div id="errreffamidb"></div>
                            </div>
                            <div class="form-group" id="tel2reffamidb">
                                <input type="tel" name="existTelefono2form" class="form-control editexist" value ="" placeholder="Teléfono Celular" data-field="tel2reffamidb">  
                                <div id="errtel2reffamidb"></div>
                            </div> 
                            <div class="form-group" id="domicilioreffamidb">
                                <input type="text" name="existeDireccionResidenciaform" class="form-control editexist" value ="" placeholder="Dirección" data-field="domicilioreffamidb">  
                                <div id="errdomicilioreffamidb"></div>
                            </div>                            
                        </div>      
                        <hr class="linesection"/>
                    </div>
                ...
                */
                ...
                <div class="wrapinfoform">
                    ...
                    <div class="row wrapdivsection">
                        ...
                        <div class="col-xs-12 col-sm-8">        
                            <div class="form-group">                            
                                <div class="form-group" id="emailreffamidb">
                                    <input type="email" id="Emailform" name="Emailform" class="form-control checkemailuser" value ="" placeholder="Email" data-field="emailreffamidb" >       
                                </div>
                                <div id="responseemailreffamidb"></div>
                                <div id="erremailreffamidb"></div>
                            </div>
                            <div class="form-group">
                        ...
                        <nav class="box100">
                            ...
                            <div id="right-bartbtn" class="row margin-hori-xs padd-verti-xs">
                                <div class="btn-toolbar pull-right" role="toolbar" aria-label="">
                                    <div class="btn-group margin-bottom-md" role="group" aria-label="">
                                        <button data-href="<?php echo $pathmm."/credits/details/"; ?>" class="btn btn-default goback" title="Eliminar Referencia Familiar" data-msj="Esta referencia nó será incluida para este credito. Deseas continuar?" data-id='<?php echo $idCreditoPOST; ?>'>
                            ...
                            <div id="responseaddrefcredito" style="display:none;">
                                <div class="alert bg-success text-green ">
                                    ...
                                    <p style="display:block;">La referencia familiar fue asignada al credito con exito</p>
                                    <button data-href="<?php echo $pathmm."/credits/details/"; ?>" type="button" class="btn btn-default godetails margin-top-xs" data-id='<?php echo $idCreditoPOST; ?>'>
                                        <i class='fa fa-chevron-left fa-lg margin-right-xs'></i>
                                        <span>Volver al credito actual</span>                     
                                    </button> 
                ...
                <div class="row">    
                    ...
                    <?php echo "<input id='paththisfile' type='hidden' value='".$pathFile."/reffamiliar.php'/>"; ?>
                </div> 
                    ...
                    <div class="media">
                        ...
                        <div class="media-body">
                            ...
                            <p style="font-size:1.232em; line-height:1;">
                                Algo salio mal cuando intentamos crear esta referencia familiar
                            </p>              
...
<script type="text/javascript" src="../../appweb/js/to-reffamiform.js"></script>  
<script type="text/javascript" src="crud-new-reffami.js"></script>    
...
<script type="text/javascript">
    ...
    */
    $('#addrefexist').click(function(){  
        ...
        $.ajax({
            type: "POST",
            url: "../../appweb/inc/valida-new-reffami.php",
            data: dataString,

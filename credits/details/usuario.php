...
if(isset($_POST['itemid_var']) && $_POST['itemid_var'] != ""){
    ...
    $valida_itemTyorPOST = validaAlphaDash($_POST['itemtype_var'], "1");
    //$valida_idRefPOST = validaInteger($_POST['itemref_var'], "1");
        
    if($valida_idItemPOST === true && $valida_itemTyorPOST ===true){   
        $loockVar = "true";      
        ...
        //DEFINIMOS QUE TIPO DE USUARIO ES
        $tipo_usuario_label = "";
        switch($typeItemPOST){
            case "deudor":
                $tipo_usuario_label = "El Deudor";
            break;
            case "codeudor":
                $tipo_usuario_label = "El Codeudor";
            break;
            case "ref_personal":
                $tipo_usuario_label = "La Ref. Personal";
            break;
            case "ref_familiar":
                $tipo_usuario_label = "La Ref. Familiar";
            break;
            case "ref_comercial":
                $tipo_usuario_label = "La Ref. Comercial";
            break;
        }
...
//si los datos del credito estan corrompidos
$idCreditoLook = (int)$_POST['itemid_var'];
$idCreditoLook = $db->escape($_POST['itemid_var']);
    ...
    <div class="content-wrapper">
        ...
        */
        ...
        <section class="content-header bg-content-header">                        
            <h1>
                <span class="text-size-x6">Credito</span> / Asignar <?php echo $tipo_usuario_label; ?>
            </h1>
        ...
        */
        ...
        <section class="content maxwidth-usersforms margin-bottom-lg">
            <form action="" id="refcomerform" autocomplete="off">
            <div class="">
                <div class="row wrapdivsection infocomercial">
                    <div class="col-xs-12 col-sm-4">                        
                        <h3>NIT</h3>
                        <label>
                            <span class="margin-right-xs">Registrar Cedula</span>
                            <input id="switchcedula" type="radio" name="opciidentiform" value="cedula" data-size="mini" class="opciidenti" checked="true">
                        </label>
                    </div>
                    <div class="col-xs-12 col-sm-8 ">
                        <small for="cedulaform" class="text-muted pull-right"><i class="fa fa-exclamation-circle fa-lg"></i> Campo obligatorio</small>
                        <div class="form-group" id="nitrefcomerdb">
                            
                            <input type="text" id="nitform" name="nitform" class="form-control checknit" value ="" placeholder="Escribe un NIT" data-field="nitrefcomerdb" >     
                        </div>
                        <div id="responsenitrefcomerdb"></div>
                        <div id="errnitrefcomerdb"></div>
                    </div>
                    <hr class="linesection"/>
                </div> 
                
                
                <div class="row wrapdivsection infonatural">
                    <div class="col-xs-12 col-sm-4">                        
                        <h3>Cédula</h3>
                        <?php if($typeItemPOST=="ref_comercial"){ ?>
                        <label>
                            <span class="margin-right-xs">Registrar NIT</span>
                            <input id="switchnit" type="radio" name="opciidentiform" value="nit" data-size="mini" class="opciidenti"  >
                        </label>
                        <?php } ?>
                    </div>
                    <div class="col-xs-12 col-sm-8 ">
                        <small for="cedulaform" class="text-muted pull-right"><i class="fa fa-exclamation-circle fa-lg"></i> Campo obligatorio</small>
                        <div class="form-group" id="refcomerdb">
                            
                            <input type="number" id="cedulaform" name="cedulaform" class="form-control checkuser" value ="" placeholder="Número identidad" data-field="refcomerdb" >     
                        </div>
                        <div id="responserefcomerdb"></div>
                        <div id="errrefcomerdb"></div>
                    </div>
                    <hr class="linesection"/>
                </div> 
                ...
                <div class="userexiste" >
                    ...
                    */
                    ...
                    <div class="row wrapdivsection">
                        ...
                        <div class="col-xs-12 col-sm-8">                                    
                            <div class="form-group" id="tel1refcomerdb">                                
                                <input type="tel" id="existTelefono1form" name="existTelefono1form" class="form-control editexist" value ="" placeholder="Telefono Fijo" data-field="tel1refcomerdb">    
                                <div id="errtel1refcomerdb"></div>
                            </div>
                            <div class="form-group" id="tel2refcomerdb">
                                <input type="tel" name="existTelefono2form" class="form-control editexist" value ="" placeholder="Teléfono Celular" data-field="tel2refcomerdb">  
                                <div id="errtel2refcomerdb"></div>
                            </div> 
                            <div class="form-group" id="domiciliorefcomerdb">
                                <input type="text" name="existeDireccionResidenciaform" class="form-control editexist" value ="" placeholder="Dirección" data-field="domiciliorefcomerdb">  
                                <div id="errdomiciliorefcomerdb"></div>
                            </div>                            
                        </div>      
                        <hr class="linesection"/>-->
                    ...
                    <?php 
                    /*
                    *INFORMACION PERSONA COMERCIAL
                    */
                    ?>
                    
                    <?php if($typeItemPOST=="ref_comercial"){ ?>
                    <div class="existinfocomercial">
                    ...
                    <div class="row wrapdivsection ">
                        ...
                        <div class="col-xs-12 col-sm-8 ">                        
                            <h4>Razon social</h4>
                            <div class="form-group">                                
                                <input type="text" id="existNombreEmpresaform" name="existNombreEmpresaform" class="form-control" value ="" placeholder="Primer nombre"  disabled>
                            </div>                        
                            <input type="text" id="existcontatoform" name="existcontatoform" class="form-control" value ="" placeholder="Nombre contacto">
                        </div>  
                        <hr class="linesection"/>
                    </div>
                    ...
                    <div class="row wrapdivsection">
                        ...
                        <div class="col-xs-12 col-sm-8">    
                            ...
                            <div class="form-group" id="tel1telempresarefcomerdbrefcomerdb">                                
                                <input type="tel" id="telempresarefcomerdb" name="existTelefonoform" class="form-control editexist" value ="" placeholder="Telefono" data-field="telempresarefcomerdb">    
                                <div id="errtelempresarefcomerdb"></div>
                            </div>                             
                            <!--<div class="form-group" id="domiciliorefcomerdb">
                                <input type="text" name="existDireccionform" class="form-control editexist" value ="" placeholder="Dirección" data-field="domiciliorefcomerdb">  
                                <div id="errdomiciliorefcomerdb"></div>
                            </div>   
                            <div class="form-group" id="domiciliorefcomerdb">
                                <input type="text" name="existCiudadEmpresaform" class="form-control editexist" value ="" placeholder="Dirección" data-field="domiciliorefcomerdb" disabled>  
                            </div>-->
                            <h4>Dirección</h4>
                            <p id="dirempresa"></p>
                ...
                */
                ...
                <div class="wrapinfoform ">
                    ...
                    <div class="row wrapdivsection">
                        ...
                        <div class="col-xs-12 col-sm-8 ">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="apellido1form" name="apellido1form" class="form-control" value ="" placeholder="Primer apellido" >      
                            </div>
                            <div class="form-group">
                            ...
                            <h4>Nacimiento</h4>
                            <div class="form-group">
                                <input type="text" name="Nacimientoform" class="form-control" value ="" placeholder="Fecha nacimiento" >     
                            </div>
                            <div class="">
                    ...
                    <div class="row wrapdivsection">
                        ...
                        <div class="col-xs-12 col-sm-8">
                            <div class="form-group">
                                <select class="form-control" name="escolaridadform">
                    ...
                    <div class="infocomercial" id="infocomerform">
                    ...
                    <div class="row wrapdivsection">
                        ...
                        <div class="col-xs-12 col-sm-8">        
                            <div class="form-group">
                                <small for="NombreEmpresaform" class="text-muted pull-right"><i class="fa fa-exclamation-circle fa-lg"></i> Campo obligatorio</small>
                                <input type="text" name="NombreEmpresaform" class="form-control" value ="" placeholder="Razon social">     
                            </div>
                            <div class="form-group">
                                <small for="contatoform" class="text-muted pull-right"><i class="fa fa-exclamation-circle fa-lg"></i> Campo obligatorio</small>
                                <input type="text" id="contatoform" name="contatoform" class="form-control" value ="" placeholder="Nombre contacto">
                            </div>
                            <div class="form-group">
                                <input type="text" name="Cargoform" class="form-control" value ="" placeholder="Cargo">     
                            </div>
                            <div class="form-group">
                                <small for="Telefonoform" class="text-muted pull-right"><i class="fa fa-exclamation-circle fa-lg"></i> Campo obligatorio</small>
                                <input type="tel" id="Telefonoform" name="Telefonoform" class="form-control" value ="" placeholder="Teléfono">     
                            </div>
                            <div class="form-group">
                    ...
                    <div class="row wrapdivsection">
                        ...
                        <div class="col-xs-12 col-sm-8">        
                            <div class="form-group">                            
                                <div class="form-group" id="emailrefcomerdb">
                                    <input type="email" id="Emailform" name="Emailform" class="form-control checkemailuser" value ="" placeholder="Email" data-field="emailrefcomerdb" >       
                                </div>
                                <div id="responseemailrefcomerdb"></div>
                                <div id="erremailrefcomerdb"></div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <input type="text" name="Telefono2form" class="form-control" value ="" placeholder="Teléfono Celular">     
                            </div>
                            <div class="form-group">
                                <input type="tel" name="DireccionResidenciaform" class="form-control" value ="" placeholder="Dirección">     
                            </div>
                ...
                <div class="wrapinfoform" id="wrappgeo">
                    ...
                    <div class="row wrapdivsection">
                        <div class="col-xs-12 col-sm-4">
                            <h3>Documentos</h3>
                            <p class="help-block">
                                Archiva documentos digitalizados para este usuario<br>
                                <span class="text-warning">Los archivos deben ser imágenes, en formatos .JPG .JPEG .PNG y max. 2MB de peso</span>
                            </p>
                        </div>                                           
                        <div class="col-xs-12 col-sm-8">        
                            <div class="form-group">
                    ...
                    <div class="row wrapdivsection">
                        ...
                        <div class="col-xs-12 col-sm-8">
                            <div class="form-group">
                                <textarea id="descri-prod" name="comentariosform" class="form-control" placeholder="Comentarios" style="width: 100%; height: 140px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px; resize: none; overflow: auto;"></textarea>
                            </div>
                        </div>
                        <hr class="linesection"/>
                    </div>
                        ...
                        <nav class="box100">
                            ...
                            <div id="right-bartbtn" class="row margin-hori-xs padd-verti-xs">
                                <div class="btn-toolbar pull-right" role="toolbar" aria-label="">
                                    <div class="btn-group margin-bottom-md" role="group" aria-label="">
                                        <button data-href="<?php echo $pathmm."/credits/details/"; ?>" class="btn btn-default goback" title="Eliminar <?php echo $tipo_usuario_label; ?>" data-msj="Este usuario nó será incluido para este credito. Deseas continuar?" data-id='<?php echo $idCreditoPOST; ?>'>
                            ...
                            <div id="userexist-bartbtn" class="row margin-hori-xs padd-verti-xs text-right" style="display:none;">
                                <button id="addrefexist" class="btn btn-default" type="button" data-field="addrefcredito">
                                    Asignar <?php echo $tipo_usuario_label; ?>
                            ...
                            <div id="responseaddrefcredito" style="display:none;">
                                <div class="alert bg-success text-green ">
                                    <h3>
                                        ...
                                        <?php echo $tipo_usuario_label; ?>
                                    </h3>
                                    <p style="display:block;">Fue asignado al credito con exito</p>
                                    <button data-href="<?php echo $pathmm."/credits/details/"; ?>" type="button" class="btn btn-default godetails margin-top-xs" data-id='<?php echo $idCreditoPOST; ?>'>
                                        <i class='fa fa-chevron-left fa-lg margin-right-xs'></i>
                                        <span>Volver al credito actual</span>                     
                                    </button> 
                ...
                <div class="row">    
                    ...
                    <input type="hidden" name="typeuserform" id="typeuserform" value="<?php echo $typeItemPOST; ?>"> 
                    <input type="hidden" name="codeuserform" id="codeuserform" value="<?php echo $idSSUser; ?>">  
                    <input type="hidden" name="userlabel" id="userlabel" value="<?php echo $tipo_usuario_label; ?>">  
                    <?php echo "<input id='pathfile' type='hidden' value='".$pathmm."'/>"; ?>
                    <?php echo "<input id='pathdir' type='hidden' value='".$creditsDir."'/>"; ?>
                    <?php echo "<input id='paththisfile' type='hidden' value='".$pathFile."/usuario.php'/>"; ?>
                </div> 
                    ...
                    <div class="media">
                        ...
                        <div class="media-body">
                            ...
                            <p style="font-size:1.232em; line-height:1;">
                                Algo salio mal cuando intentamos crear este usuario
                            </p>              
                ...
                <div class="margin-verti-xs">
                    <div class="btn-toolbar" role="toolbar">                                           
                        <div class="btn-group text-center">                            
                            <button data-href="<?php echo $pathmm."/credits/details/"; ?>" type="button" class="btn btn-info godetails" data-id='<?php echo $idCreditoLook; ?>'>
                                <i class='fa fa-chevron-left fa-lg margin-right-xs'></i>
                                <span>Volver al credito actual</span>                     
                            </button>                                                               
                        </div>
...
<script type="text/javascript" src="../../appweb/js/to-refcomerform.js"></script>   
<script type="text/javascript" src="crud-new-usuario.js"></script>    
...
<script type="text/javascript">
    ...
    $(document).ready(function() {   
        ...
        $('input[name="nitform"]').inputmask({
            mask: "9[9][9].999.999-9",
            alias: "###.###.###-#",
            greedy: false,
    ...
    $(".opciidenti").bootstrapSwitch(); 

    
    $(".infocomercial").hide();
    $(".infonatural").show();
    
    $("#switchnit").on('switchChange.bootstrapSwitch', function(event, state) {
        if($(this).is(':checked')) {
            $(".infocomercial").fadeIn(); 
            $(".infonatural").fadeOut();
            ...
            $('input[name="cedulaform"]').val('');
            $("#responserefcomerdb").hide();
            
            //$("#opciidentiform").val("nit");
        }
    });

    $("#switchcedula").on('switchChange.bootstrapSwitch', function(event, state) {
        if($(this).is(':checked')) {
            $(".infocomercial").fadeOut(); 
            $(".infonatural").fadeIn();
            ...
            $('input[name="nitform"]').val('');
            $("#responsenitrefcomerdb").hide();
            
            //$("#opciidentiform").val("cedula");
        }
    });
    ...
    */
    $('#addrefexist').click(function(){  
        ...
        var dataString = 'itemusuario='+idref+'&itemcredito='+creditoform+'&fieldedit='+$(this).attr('data-field')+'&typeuserform='+typeuserform;

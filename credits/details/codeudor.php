    ...
    <div class="content-wrapper">
        ...
        */
        ...
        <section class="content-header bg-content-header">                        
            <h1>
                <span class="text-size-x6">Credito</span> / Nuevo Codeudor
            </h1>
        ...
        */
        ...
        <section class="content maxwidth-usersforms margin-bottom-lg">
            ...
            <form action="" id="codeudorform" autocomplete="off">
            <div class="">
                ...
                <div class="row wrapdivsection">
                    ...
                    <div class="col-xs-12 col-sm-8 ">
                        ...
                        <div class="form-group" id="codeudordb">
                            
                            <input type="number" id="cedulaform" name="cedulaform" class="form-control checkuser" value ="" placeholder="Número identidad" data-field="codeudordb" >     
                        </div>
                        <div id="responsecodeudordb"></div>
                        <div id="errcodeudordb"></div>
                    </div>
                ...
                */
                ...
                <div class="userexiste" >
                    ...
                    <div class="row wrapdivsection">
                        ...
                        <div class="col-xs-12 col-sm-8">                                    
                            <div class="form-group" id="tel1codeudordb">                                
                                <input type="tel" id="existTelefono1form" name="existTelefono1form" class="form-control editexist" value ="" placeholder="Telefono Fijo" data-field="tel1codeudordb">    
                                <div id="errtel1codeudordb"></div>
                            </div>
                            <div class="form-group" id="tel2codeudordb">
                                <input type="tel" name="existTelefono2form" class="form-control editexist" value ="" placeholder="Teléfono Celular" data-field="tel2codeudordb">  
                                <div id="errtel2codeudordb"></div>
                            </div> 
                            <div class="form-group" id="domiciliocodeudordb">
                                <input type="text" name="existeDireccionResidenciaform" class="form-control editexist" value ="" placeholder="Dirección" data-field="domiciliocodeudordb">  
                                <div id="errdomiciliocodeudordb"></div>
                            </div>                            
                        </div>      
                        <hr class="linesection"/>
                    </div>
                ...
                */
                ...
                <div class="wrapinfoform">
                    ...
                    <div class="row wrapdivsection">
                        ...
                        <div class="col-xs-12 col-sm-8">        
                            <div class="form-group">
                                <div class="form-group" id="emailcodeudordb">
                                    <input type="email" id="Emailform" name="Emailform" class="form-control checkemailuser" value ="" placeholder="Email" data-field="emailcodeudordb" >       
                                </div>
                                <div id="responseemailcodeudordb"></div>
                                <div id="erremailcodeudordb"></div>
                            </div>
                            <div class="form-group">
                        ...
                        <nav class="box100">
                            ...
                            <div id="right-bartbtn" class="row margin-hori-xs padd-verti-xs">
                                <div class="btn-toolbar pull-right" role="toolbar" aria-label="">
                                    <div class="btn-group margin-bottom-md" role="group" aria-label="">
                                        <button data-href="<?php echo $pathmm."/credits/details/"; ?>" class="btn btn-default goback" title="Eliminar Codeudor" data-msj="Esta referencia nó será incluida para este credito. Deseas continuar?" data-id='<?php echo $idCreditoPOST; ?>'>
                            ...
                            <div id="responseaddrefcredito" style="display:none;">
                                <div class="alert bg-success text-green ">
                                    ...
                                    <p style="display:block;">Este codeudor fue asignado al credito con exito</p>
                                    <button data-href="<?php echo $pathmm."/credits/details/"; ?>" type="button" class="btn btn-default godetails margin-top-xs" data-id='<?php echo $idCreditoPOST; ?>'>
                                        <i class='fa fa-chevron-left fa-lg margin-right-xs'></i>
                                        <span>Volver al credito actual</span>                     
                                    </button> 
                ...
                <div class="row">    
                    ...
                    <?php echo "<input id='paththisfile' type='hidden' value='".$pathFile."/codeudor.php'/>"; ?>
                </div> 
            </div>
            </form>
        </section>   
                    ...
                    <div class="media">
                        ...
                        <div class="media-body">
                            ...
                            <p style="font-size:1.232em; line-height:1;">
                                Algo salio mal cuando intentamos crear un nuevo codeudor
                            </p>              
...
<script type="text/javascript" src="../../appweb/js/to-codeudorform.js"></script>     
<script type="text/javascript" src="crud-new-codeudor.js"></script> 
...
<script type="text/javascript">
    ...
    */
    $('#addrefexist').click(function(){  
        ...
        $.ajax({
            type: "POST",
            url: "../../appweb/inc/valida-new-codeudor.php",
            data: dataString,

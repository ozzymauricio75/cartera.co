...
$codeNewProd ="";
$loockVar = "false";      
if(isset($_POST['itemref_var']) && $_POST['itemref_var'] != ""){
    ...
    <div class="content-wrapper">
        ...
        */
        ...
        <section class="content-header bg-content-header">                        
            <h1>
                <span class="text-size-x6">Credito</span> / Nueva Referencia Comercial
            </h1>
            ...
            <div class="">
                <div class="row wrapdivsection infocomercial">
                    <div class="col-xs-12 col-sm-4">                        
                        ...
                        <label>
                            ...
                            <input id="switchcedula" type="radio" name="opciidentiform" value="cedula" data-size="mini" class="opciidenti">
                        </label>
                    </div>
                ...
                <div class="row wrapdivsection infonatural">
                    <div class="col-xs-12 col-sm-4">                        
                        ...
                        <label>
                            ...
                            <input id="switchnit" type="radio" name="opciidentiform" value="nit" data-size="mini" class="opciidenti"  checked="true">
                        </label>
                    </div>
                    <div class="col-xs-12 col-sm-8 ">
                        <small for="cedulaform" class="text-muted pull-right"><i class="fa fa-exclamation-circle fa-lg"></i> Campo obligatorio</small>
                ...
                */
                        ...
                        <nav class="box100">
                            ...
                            <div id="right-bartbtn" class="row margin-hori-xs padd-verti-xs">
                                <div class="btn-toolbar pull-right" role="toolbar" aria-label="">
                                    <div class="btn-group margin-bottom-md" role="group" aria-label="">
                                        <button data-href="<?php echo $pathmm."/credits/details/"; ?>" class="btn btn-default goback" title="Eliminar Referencia Comercial" data-msj="Esta referencia nó será incluida para este credito. Deseas continuar?" data-id='<?php echo $idCreditoPOST; ?>'>
                            ...
                            <div id="responseaddrefcredito" style="display:none;">
                                <div class="alert bg-success text-green ">
                                    ...
                                    <p style="display:block;">La referencia comercial fue asignada al credito con exito</p>
                                    <button data-href="<?php echo $pathmm."/credits/details/"; ?>" type="button" class="btn btn-default godetails margin-top-xs" data-id='<?php echo $idCreditoPOST; ?>'>
                                        <i class='fa fa-chevron-left fa-lg margin-right-xs'></i>
                                        <span>Volver al credito actual</span>                     
                                    </button> 
                ...
                <div class="row">    
                    ...
                    <input type="hidden" name="deudorform" id="deudorform" value="<?php echo $idDeudorPOST; ?>">   
                    ...
                    <?php echo "<input id='paththisfile' type='hidden' value='".$pathFile."/refcomercial.php'/>"; ?>
                </div> 
                    ...
                    <div class="media">
                        ...
                        <div class="media-body">
                            ...
                            <p style="font-size:1.232em; line-height:1;">
                                Algo salio mal cuando intentamos crear esta referencia comercial
                            </p>              
...
<script type="text/javascript" src="crud-new-refcomer.js"></script>    
...
<script type="text/javascript">
    ...
    */
    $('#addrefexist').click(function(){  
        ...
        $.ajax({
            type: "POST",
            url: "../../appweb/inc/valida-new-refcomer.php",
            data: dataString,

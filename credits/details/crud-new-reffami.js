$(document).ready(function(){ 
    ...
    $("#additembtn").click(function(){
        ...
        var form = document.getElementById('reffamiform');
            ...
            success: function (data) {
                ...
                if (response["error"]) { 
                    ...
                    $("#wrapadditem"+" .loader").fadeOut(function(){
                        ...
                        $("#wrapadditem").html("<div class='alert bg-success text-green alert-dismissible'><button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button><h4><i class='icon fa fa-check margin-right-xs'></i> Referencia familiar </h4><p style='display:block;'>Esta referencia fue creada y asignada al credito con exito</p></div>").fadeIn("slow");
                                                                        
                        //$("#left-barbtn").append("<a href='"+pathfile+"/"+ pathdir+"/new-step5.php' class='btn btn-default'><span>Continuar</span><i class='fa fa-chevron-right fa-1x margin-left-xs'></i></a><a href='"+pathfile+"/"+ pathdir+"/new-step4.php?gocredito=ok&dbtype=reffamidb' class='btn bg-teal margin-hori-xs'><span>Crear credito ahora</span><i class='fa fa-arrow-right fa-1x margin-left-xs'></i></a>").show();

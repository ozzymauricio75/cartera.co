$(document).ready(function(){ 
    ...
    $("#additembtn").click(function(){
        ...
        */
        ...
        var tipocreditoinput = $("#tipocreditoinput").val();
        formData.append("tipocreditopost", tipocreditoinput);
        ...
        var creditactualinput = $("input[name='creditactualform']").val();
        formData.append("creditactualpost", creditactualinput );
        ...
        */
        ...
        if (formData) {
          $.ajax({
            url: "valida-refinance-credito.php",
            type: "POST",
            data: formData,
            processData: false,
            contentType: false,

...
if(isset($fieldPost) && $fieldPost == "additem"){    
    ...
    */                         
    ...
    $filters = array(
        //'idrefperso'=> 'trim|sanitize_string',
	...
	if($validated === TRUE && $checkTels != "error"){
        ...
        //*************
        */
        $db->where('email_referencia_personal', $Email);
        $db->where('email_referencia_personal', "", "!=");
        $emailExist = $db->getOne('referencia_personal_tbl');
        ...
        //***********
        /*$tablaExiQ = "referencia_personal_tbl";
        $campoExiQ = "cedula_referencia_personal";
        ...
        if($deudorExiste == false){//SI EXISTE EL REGISTRO
            ...
            foreach($nuevoPost as $valInsert){
                $dataInsert = array(                
                    ...
                    'primer_nombre_referencia_personal' => $nuevoPost['primernombre'],
                    'segundo_nombre_referencia_personal' =>$nuevoPost['segundonombre'],
                    'primer_apellido_referencia_personal'=>  $nuevoPost['PrimerApellido'],    
                    'segundo_apellido_referencia_personal'=> $nuevoPost['segundoapellido'],
                    'cedula_referencia_personal' =>$nuevoPost['NumeroDocumento'],
                    'fecha_nacimiento_referencia_personal'=> $nuevoPost['Fecha_Nacimiento'],  
                    'lugar_naciminto_referencia_personal'=> $nuevoPost['Lugar_Nacimiento'], 
                    'genero_referencia_personal'=> $nuevoPost['Genero'],  
                    'estado_civil_referencia_personal'=> $nuevoPost['Estado_Civil'],  
                    'email_referencia_personal' =>  $nuevoPost['Email'],
                    'tel_uno_referencia_personal' => $nuevoPost['Telefono1'],
                    'tel_dos_referencia_personal' =>$nuevoPost['Telefono2'],
                    'dir_domicilio_referencia_personal'=>  $nuevoPost['Direccion_Residencia'],
                    'complemento_dir_referencia_personal'=> $nuevoPost['Complemento'],
                    'barrio_domicilio_referencia_personal' =>$nuevoPost['Barrio'],
                    'tipo_vivienda_referencia_personal'=> $nuevoPost['Tipo_Vivienda'],       
                    'estrato_social_referencia_personal'=> $nuevoPost['Estrato'],            
                    //'dir_geo_referencia_personal' => $direccionFullPost,
                    //'latitud_geo_referencia_personal' => $latstore,
                    //'longitud_geo_referencia_personal'=>$lngstore,
                    //'url_maps_referencia_personal'=> $idMapPost,
                    //'codigo_geo_ciudad_referencia_personal' => $usercityUser,
                    //'codigo_geo_estado_referencia_personal' => $userstate,
                    //'codigo_geo_pais_referencia_personal'=> $paisPost,
                    //'codigo_postal_geo_referencia_personal' =>$userzip,                    
                    'nivel_escolaridad_referencia_personal' => $nuevoPost['escolaridad'],    
                    'oficio_referencia_personal' => $nuevoPost['Oficio'],
                    'profesion_referencia_personal' =>$nuevoPost['Profesion'],
                    'nombre_empresa_referencia_personal'=>$nuevoPost['Nombre_Empresa'],
                    'cargo_empresa_referencia_personal'=>$nuevoPost['Cargo'],
                    'tel_empresa_referencia_personal'=>$nuevoPost['Telefono'],
                    'dir_empresa_referencia_personal'=>$nuevoPost['Direccion'],
                    'ciudad_empresa_referencia_personal'=>$nuevoPost['Ciudad_Empresa'],      
                    'comentarios_referencia_personal'=>$nuevoPost['comentarios'],
                    'fecha_alta_referencia_personal'=> $dateFormatDB
                );  
            }
            //echo "<pre>";
            ...
            //if (!$id){
            //$db->where ('id_referencia_personal',$id_refperso); 
            $newRefPersoINS = $db->insert ('referencia_personal_tbl', $dataInsert);
            ...
            if ($newRefPersoINS){ 
                            ...
                            if(upimgfile($valF['name'], $valF['tmp_name'])){
                                ...
                                if(redimensionaImgFile($valF['name'], $valF['type'], $nameFileSponsorF, $patFileEnd, $squareFile)){ 
                                    ...
                                    if(redimensionaImgFile($valF['name'], $valF['type'], $nameFileSponsorF, $patFileEndThumb, $squareFileThumb)){
                                        ...
                                        $idSponsor = $db->rawQuery("INSERT INTO documentos_requisitos_tbl (id_acreedor, id_referencia_personal, referencia_documento_requisito, file_documento_requisito) VALUES('".$id_acreedor."', '".$newRefPersoINS."','".$refAlbumInsert."',  '".$nameFileSponsorF.".jpg')");
                                        if(!isset($idSponsor)){ 
                ...
                $dataUpdateCredito = array("id_referencia_personal"=>$newRefPersoINS);
            ...
            foreach($valRules as $key => $v){
                ...
                switch($errFiel){
                    ...
                    case 'Cargo' :
                        ...
                        <br>".$usertyped."
                        <br>Reglas:                                   
                        <br>Escribe el cargo en la empresa que trabaja, puedes usar letras y números</li>";
                    break;                        
                    case 'Telefono' :
                    ...
                    case 'comentarios' :
                        ...
                        <br>".$usertyped."
                        <br>Reglas:
                        <br>Escribe una pequeña reseña o descripción

...
if(!empty($fieldPost) && $fieldPost == "resetsystem"){
    ...
    *GASTOS
    */
    $truncate_gastos_tbl = $db->rawQuery("TRUNCATE TABLE gastos_tbl");
    ...
    */
    ...
    /*if(!$resetCustomUser){
        ...
        $errQueryTmpl .="<li class='list-group-item list-group-item-danger'>
            <b>*** Algo salio mal ***</b><br>
            <br>Wrong: <b>No fue posible reestablecer tu configuraci¨®n de usuario</b>
    ...
    *USUARIOS ESCAPADOS
    */    
    $truncate_usuarios_escapados_tbl = $db->rawQuery("TRUNCATE TABLE usuario_escapado");
    
    
    /*
    *VALORES COBRAR DIA
    */    
    $truncate_valores_dia_tbl = $db->rawQuery("TRUNCATE TABLE valores_cobrar_dia");
...
if(!empty($fieldPost) && $fieldPost == "resetuser"){
    ...
    */    
    $db->where("id_acreedor", $idSSUser);
    $delete_gastos_tbl = $db->delete("gastos_tbl");
    ...
    */
    ...
    /*
    *RESET USUARIOS ESCAPADOS
    */    
    $db->where("id_acreedor", $idSSUser);
    $nick_acreedor = $db->getOne("acreedor_tbl", "nickname_acreedor");
    
    $db->where("usuario_acreedor", $nick_acreedor["nickname_acreedor"]);    
    $delete_usuarios_escapados_tbl = $db->delete("usuario_escapado");
    
    /*
    *RESET VALORES COBRAR DIA
    */    
    $db->where("id_acreedor", $idSSUser);
    $delete_valores_dia_tbl = $db->delete("valores_cobrar_dia");

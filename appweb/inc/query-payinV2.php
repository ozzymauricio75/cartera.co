...
function queryValorAcumulado($concecutivo){
    ...
    $queryTbl = $db->getOne ("recaudos_tbl", "SUM(total_cuota_plan_pago) AS totalcuotas, SUM(total_valor_recaudado_estacuota) AS totalrecaudos, activa_mora as actimora, valor_mora_cuota_recaudo as valormora");

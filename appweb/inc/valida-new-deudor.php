...
if(isset($fieldPost) && $fieldPost == "additem"){    
    ...
    */
    ...
    //$id_deudor = (empty($_POST['codeitemform']))? "" : $_POST['codeitemform'];
	...
	if($validated === TRUE && $checkTels != "error"){
        ...
        */
        ...
        if($deudorExiste == false){//SI EXISTE EL REGISTRO
            ...
            //if ($db->update ('deudor_tbl', $dataInsert)){  
            $newDeudorINS = $db->insert ('deudor_tbl', $dataInsert);
            if ($newDeudorINS){   
                //***********
                //DATOS REF
                //***********
                            ...
                            if(upimgfile($valF['name'], $valF['tmp_name'])){
                                ...
                                if(redimensionaImgFile($valF['name'], $valF['type'], $nameFileSponsorF, $patFileEnd, $squareFile)){ 
                                    ...
                                    if(redimensionaImgFile($valF['name'], $valF['type'], $nameFileSponsorF, $patFileEndThumb, $squareFileThumb)){
                                        ...
                                        $idSponsor = $db->rawQuery("INSERT INTO documentos_requisitos_tbl (id_acreedor, id_deudor, referencia_documento_requisito, file_documento_requisito) VALUES('".$id_acreedor."', ".$newDeudorINS."','".$refAlbumInsert."',  '".$nameFileSponsorF.".jpg')");
                                        if(!isset($idSponsor)){ 
                ...
                if($actualizaCredito && $actualizaPlanPago){
                    ...
                    $errQueryTmpl_ins .="<li class='list-group-item list-group-item-danger'><b>*** Algo salio mal ***</b><br>
                        <br>Wrong: <b>No fue posible asignar este deudor al credito</b>
                        <br>Erro: ".$errInsertDatas."
                        <br>Regresa al credito actual, y da click en la opción DEUDOR para intentar asignarlo nuevamente
                        <br>Si el error continua, por favor entre en contacto con soporte</li>";
                    $errQueryTmpl_ins .="</ul>";
                ...
                $errQueryTmpl_ins ="<ul class='list-group text-left'>";
                $errQueryTmpl_ins .="<li class='list-group-item list-group-item-danger'><b>*** Algo salio mal ***</b><br>
                    <br>Wrong: <b>No se pudo crear este deudor</b>
                    <br>Erro: ".$errInsertDatas."
                    <br>Puedes intentar de nuevo
                    <br>Si el error continua, por favor entre en contacto con soporte</li>";
                $errQueryTmpl_ins .="</ul>";
            ...
            foreach($valRules as $key => $v){
                ...
                switch($errFiel){
                    ...
                    case 'iddeudor' :
                        ...
                        <br>".$usertyped."
                        <br>Parece que ha ocurrido un error en el momento de crear este Deudor, por favor, intenta crear un nuevo Credito, en la opción CREAR / NUEVO CREDITO</li>";
                    break; */                       
                    case 'primernombre' :

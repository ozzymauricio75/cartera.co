...
function queryValorRecaudosRutaHoy($idAcreedor_, $fechaRecaudo_){
    ...
    $queryTbl = $db->get ("recaudos_tbl", null, "total_cuota_plan_pago, valor_faltante_cuota, valor_cuota_recaulcaldo_recaudos, total_valor_recaudado_estacuota, activa_mora, valor_mora_cuota_recaudo");

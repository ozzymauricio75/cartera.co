...
if(isset($fieldPost) && $fieldPost == "newcuadrecaja"){   
    ...
    */
    ...
    //=="undefined"
    $totalDineroRutaHoy = ($_POST['valcobrarhoypost'] != "")? $_POST['valcobrarhoypost'] : "";
    $total_capital_ruta_hoy = ($_POST['abonocapitalhoypost'] != "")? $_POST['abonocapitalhoypost'] : "";
    $total_utilidad_ruta_hoy = ($_POST['utilidadhoypost'] != "")? $_POST['utilidadhoypost'] : "";
    ...
    */
    ...
    $_POST = array( 
        ...
        'valorrecaudarhoy' => $totalDineroRutaHoy,
        'abonocapitalhoy' => $total_capital_ruta_hoy,
        'utilidadhoy' => $total_utilidad_ruta_hoy,
        'valordisponiblehoy' => $valorDisponible
    );
                
	$rules = array(
        'id_acreedor' => 'required|integer',		        
        'totalrecaudos' => 'required|float|max_len,10',		
        'totalgastosrecaudos' => 'required|float|max_len,10',	
        'descrirecaudos' => 'alpha_space',
        'fecharecaudo' => 'required|date',
        'valorrecaudarhoy' => 'float|max_len,10',
        'abonocapitalhoy' => 'float|max_len,10',
        'utilidadhoy' => 'float|max_len,10',
        'valordisponiblehoy' => 'float|max_len,15'
    );
	...
	$filters = array(
        ...
        'valorrecaudarhoy' => 'trim|sanitize_string',
        'abonocapitalhoy' => 'trim|sanitize_string',
        'utilidadhoy' => 'trim|sanitize_string',
        'valordisponiblehoy' => 'trim|sanitize_string',
    ); 
	...
	if($validated === TRUE && $candado == "on"){
        ...
        $datainsert_valorescobrartbl = array( 
            ...
            "fecha_valores_cobrar_dia" => $fechaRecaudosPost
        );
        ...
        //ingrezar valores a tabla caja menor        
        ...
        foreach($recibeRules as $keyRules => $valRules){
            foreach($valRules as $key => $v){
                ...
                switch($errFiel){
                    ...
                    case 'valorrecaudarhoy' :
                        $errValidaTmpl .= "<li class='list-group-item list-group-item-danger'><b>Valor a recaudar hoy</b>
                        <br>".$usertyped."
                        <br>Reglas:
                        <br>Campo obligatrorio
                        <br>Se detectaron datos incoherentes en este valor. Por favor reinicia tu session e intenta cuadrar caja nuevamente</li>";
                    break;
                        
                    case 'abonocapitalhoy' :
                        $errValidaTmpl .= "<li class='list-group-item list-group-item-danger'><b>Abono a capital hoy</b>
                        <br>".$usertyped."
                        <br>Reglas:
                        <br>Campo obligatrorio
                        <br>Se detectaron datos incoherentes en este valor. Por favor reinicia tu session e intenta cuadrar caja nuevamente</li>";
                    ...
                    case 'utilidadhoy' :
                        $errValidaTmpl .= "<li class='list-group-item list-group-item-danger'><b>Abono a interes hoy</b>
                        <br>".$usertyped."
                        <br>Reglas:
                        <br>Campo obligatrorio
                        <br>Se detectaron datos incoherentes en este valor. Por favor reinicia tu session e intenta cuadrar caja nuevamente</li>";
                    ...
                    case 'valordisponiblehoy' :
                        $errValidaTmpl .= "<li class='list-group-item list-group-item-danger'><b>Valor disponible</b>
                        <br>".$usertyped."
                        <br>Reglas:
                        <br>Campo obligatrorio
                        <br>Se detectaron datos incoherentes en este valor. Por favor reinicia tu session e intenta cuadrar caja nuevamente</li>";

...
switch($rootLevel){
    ...
    case "creditos":
        ...
        if(!empty($sectionLevel)){
            ...
            if($sectionLevel=="consultacredito"){
                $credits_report = "active";    
            }
        }
    break;
...
<div class="btn-group margin-hori-xs margin-verti-md">
  ...
  <a href="'.$pathmm.'/quser/" type="button" class="btn btn-lg bg-olive text-shadow">
...
$tmplSideAS .= '<li class="treeview '.$pedido_root.'">
          ...
          <ul class="treeview-menu">
            <li class="'.$credits_list.'"><a href="'.$pathmm.'/credits/"><i class="fa fa-chevron-circle-right"></i> Lista de creditos</a></li>           
            <li class="'.$credits_report.'"><a href="'.$pathmm.'/credits/qcredits/"><i class="fa fa-chevron-circle-right"></i> Consulta</a></li>           
          </ul>
        </li>';
...
$tmplSideAS .= '<li class="treeview '.$reportes_root.'">
            <a href="'.$pathmm.'/report/">

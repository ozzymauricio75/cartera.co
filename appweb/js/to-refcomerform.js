    ...
    validate : { 
        'cedulaform' : {
            ...
            'length' : '7-12',
             ...
             '_data-sanitize': 'trim',
            'optional-if-answered' : 'nitform',
            //'error-msg-required' : 'Escribe el número de cedula',
            'error-msg-length' : 'La cedula debe tener entre 7 y 12 caracteres',
            'error-msg-number' : 'Escribe un número de cdula. Sólo puedes usar numeros, sin espacios o simbolos',
        },
        'nitform' : {
            'validation' : 'length, custom',
            'length' : '7-13',
            'regexp' : '^[0-9.-]*$',
             'help' : 'Escribe el NIT de la empresa: ###.###.###-# Si en el primer grupo de números es inferior a TRES (3) digitos, presiona [ESPACIO] en tu teclado y continua con el siguiente grupo',
             '_data-sanitize': 'trim',
            'optional-if-answered' : 'cedulaform',
            //'error-msg-required' : 'Escribe el número de cedula',
            'error-msg-length' : 'El NIT debe tener entre 7 y 13 caracteres',
            'error-msg-number' : 'Escribe un NIT. Sólo puedes usar números, puntos (.) y el guion (-)',
        },
        'nombre1form' : {
        ...
        'NombreEmpresaform' : {
            ...
            'length' : '4-60',
            '_data-sanitize': 'trim',
            'error-msg-required' : 'Escribe el nombre de la empresa',
        ...
        'contatoform' : {
            ...
            'length' : '4-50',
            '_data-sanitize': 'trim',
            'error-msg-required' : 'Escribe el nombre de la persona contacto en la empresa',
            'error-msg-length' : 'El nombre de la empresa debe tener entre 4 y 50 caracteres',
            'error-msg-custom' : 'Escribe un nombre de empresa valido, no uses simbolos ni signos de puntuación',
        },
        'Cargoform' : {
            'validation' : 'length, custom',
        ...
        'Telefonoform' : {
            ...
            '_data-sanitize': 'trim',
            'error-msg-required' : 'Escribe el número de teléfono de la empresa',

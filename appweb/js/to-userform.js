...
var config = {        
    ...
    validate : {        
        'capitalinicialform' : {
            ...
            'error-msg-length' : 'El número que escribiste no debe ser mayor a 9 digitos',
        ...
        'userform' : {
            ...
            'regexp' : '^([a-zA-Z0-9._-])+$',
            'length' : '4-15',  
            'help' : 'Escribe un nombre de usuario de 4 a 15 caracteres, puedes usar letras, números y los catacteres (._-)',
            '_data-sanitize': 'trim',
             'error-msg-required' : 'Escribe un nombre de usuario',
            'error-msg-length' : 'El nombre de usuario debe tener entre 4 y 15 caracteres',
            'error-msg-custom' : 'Puedes usar letras, números y los caracteres (.-_)',
        },
        'passform_confirmation' : {
            'validation' : 'required, length, custom',
            'regexp' : '^([a-zA-Z0-9!@#$%&()+._-])+$',
            'length' : '4-12',  
            'help' : 'Escribe una contraseña entre 4 y 12 caracteres, puedes usar letras, números y los catacteres (!@#$%&()+.-_)',
            '_data-sanitize': 'trim',
             'error-msg-required' : 'Escribe una contraseña',
            'error-msg-length' : 'La contraseña debe tener entre 4 y 12 caracteres',
            'error-msg-custom' : 'Puedes usar letras, números y los caracteres (!@#$%&()+.-_)',
        },
        'passform' : {
            'validation' : 'confirmation',            
            '_data-sanitize': 'trim',            
            'error-msg-confirmation' : 'Las contraseñas no coinciden',
...
$.validate({ 
    //form : '#deudorform', 
    modules : 'jsconf, html5, sanitize, date, logic, security',
    lang : 'es',
    ...
    onModulesLoaded : function() {
        var passConfig = {
            ...
            fontWeight: 'normal',
            display:'block',
            bad : 'Nivel seguridad bajo',
            weak : 'Nivel seguridad debil',
            good : 'Nivel seguridad bueno',
            strong : 'Nivel seguridad fuerte'
        };
        $('input[name="passform_confirmation"]').displayPasswordStrength(passConfig);
